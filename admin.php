...
<head>
    ...
    <title>Web Bunga Matahari | Admin</title>
...
<body>
    ...
    <div class="container">
        <a class="navbar-brand" href="">Web Bunga Matahari</a>
        <button
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-dark">
            ...
            <li class="nav-item">
                <a class="nav-link" href="admin.php?page=gallery">Galery</a>
            </li>
            <li class="nav-item">
...
<!-- content end -->
    ...
    <div>Muhammad Hibnu Putra Arif &copy; 2024</div>
    </footer>
    <!-- footer end -->
    <script
